...
class DTC extends Client implements ClientInterface {
    private $host = "http://dangkytinchi.ictu.edu.vn/";
    private $prefix = "kcntt";
    ...
    public function getStudent () {
        ...
        $student->Truong = "Đại Học Công Nghệ Thông Tin & Truyển Thông - Đại Học Thái Nguyên";
