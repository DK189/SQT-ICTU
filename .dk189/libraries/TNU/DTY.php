...
class DTY extends Client implements ClientInterface {
    private $host = "http://quanlydaotao.tump.edu.vn/";
    private $prefix = "dhyd";
    ...
    public function getStudent () {
        ...
        $student->Truong = "Trường Đại học Y Dược - Đại học Thái Nguyên";
