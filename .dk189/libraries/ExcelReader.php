...
define('ExcelReader_TYPE_FONT',	  0x0031);
define('ExcelReader_TYPE_PALETTE',	  0x0092);
...
define('ExcelReader_TYPE_HYPER',	     0x01b8);
define('ExcelReader_TYPE_COLINFO',	     0x7d);
define('ExcelReader_TYPE_DEFCOLWIDTH',  0x55);
define('ExcelReader_TYPE_STANDARDWIDTH', 0x99);
...
class ExcelReader {
	...
	public		$_defaultFormat = ExcelReader_DEF_NUM_FORMAT;
	...
	function _parsesheet($spos) {
		...
		function _getCellDetails($spos,$numValue,$column) {
			...
			if ($type == 'date') {
				...
				$utcDays = floor($numValue - ($this->nineteenFour ? ExcelReader_UTCOFFSETDAYS1904 : ExcelReader_UTCOFFSETDAYS));
				$utcValue = ($utcDays) * ExcelReader_MSINADAY;
				...
				$totalseconds = floor(ExcelReader_MSINADAY * $fractionalDay);
